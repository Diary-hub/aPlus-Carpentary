        ...
        <el-dialog v-model="dialogVisible" width="500" :before-close="handleClose" style="border-radius: 2%">
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-2xl ">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">{{ editMode ? 'Edit Category' :
                        'Add Category' }}</h2>
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <button type="button" @click="openAddModal" v-if="permission.canEditCategory"
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            <button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown"
                                v-if="permission.canEditCategory"
                        ...
                        <tbody>
                            <tr v-for="category in categories" :key="category.id" class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    ...
                                    <div :id="category.id + '-dropdown'" v-if="permission.canEditCategory"
                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            :aria-labelledby="category.id + '-dropdown'">
                                            <li>
                                                <a href="#"
                                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>
                                            </li>
                                            <li>
                                                <a @click="openEditModal(category)" href="#"
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        ...
                        of
                        <span class="font-semibold text-gray-900 dark:text-white">{{ categories.length }}</span>
                    </span>
