...
const openEditModal = (company) => {
    ...
    // Update the data based on the selected company
    id.value = company.id;
...
const addCompany = async () => {
    ...
    try {
        await router.post('companies/store', formData, {
            onSuccess: page => {
                Swal.fire({
                    toast: true,
                    icon: 'success',
...
const updateCompany = async () => {
    ...
    try {
        await router.post('companies/update/' + id.value, formData, {
            onSuccess: page => {
                Swal.fire({
                    toast: true,
                    icon: 'success',
...
const deleteCompany = (company, index) => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            try {
                router.delete('companies/destroy/' + company.id, {
                    onSuccess: (page) => {
                        //                        props.products.splice(index, 1);
                        this.delete(company, index);
        ...
        <el-dialog v-model="dialogVisible" width="500" :before-close="handleClose" style="border-radius: 2%">
            <section class="bg-white dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-2xl ">
                    <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">{{ editMode ? 'Edit Company' :
                        'Add Company' }}</h2>
                    <form @submit.prevent=" editMode ? updateCompany() : addCompany()">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                <div
                    ...
                    <div
                        ...
                        <button type="button" @click="openAddModal" v-if="permission.canEditCompany"
                        ...
                        <div class="flex items-center space-x-3 w-full md:w-auto">
                            <button id="actionsDropdownButton" data-dropdown-toggle="actionsDropdown"
                                v-if="permission.canEditCompany"
                ...
                <div class="overflow-x-auto min-h-[40vh]">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr v-for="company in companies" :key="company.id" class="border-b dark:border-gray-700">
                                <th scope="row"
                                    class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    {{ company.name }}</th>

                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button :id="company.id + '-button'"
                                        :data-dropdown-toggle="company.id + '-dropdown'"
                                    ...
                                    <div :id="company.id + '-dropdown'" v-if="permission.canEditCompany"
                                        class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                            :aria-labelledby="company.id + '-dropdown'">
                                            <li>
                                                <a href="#"
                                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>
                                            </li>
                                            <li>
                                                <a @click="openEditModal(company)" href="#"
                                                    class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                            </li>
                                        </ul>
                                        <div class="py-1">
                                            <a href="#" @click="deleteCompany(company, index)"
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        ...
                        of
                        <span class="font-semibold text-gray-900 dark:text-white">{{ companies.length }}</span>
                    </span>
